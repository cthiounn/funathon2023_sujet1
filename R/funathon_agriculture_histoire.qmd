...
leaflet(data = surfaces_ra1852_final) %>% addTiles() %>%
  addMarkers(~longitude, ~latitude, popup = ~as.character(canton), label = ~as.character(canton))
...
-   nous avons une surface géographique que l'on souhaite découper en zone (des cantons).
    -   nous connaissons le chef lieu de chaque zone. Ce n'est pas forcément le centre mais en tant que chef-lieu, nous considérons que sa zone d'influence l'entoure.
